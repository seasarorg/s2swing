...
public class JListItemsBinder extends AbstractBinder {
    public boolean accepts(BindingDesc bindingDesc) {
        if (JList.class.isAssignableFrom(bindingDesc.getTargetObjectDesc()
                .getPropertyType())) {
    ...
    protected Binding doCreateBinding(BindingDesc bindingDesc, Object source,
        ...
        return SwingBindings.createJListBinding(
                bindingDesc.getUpdateStrategy(), source, sourceProp,
                (JList) target);
    }
}
